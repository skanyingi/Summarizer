    ...
    <div className="flex min-h-screen">
      ...
      <main className="md:ml-64 min-h-screen relative flex flex-col items-center justify-center p-8 w-full">
        <div className="max-w-4xl w-full flex flex-col items-center gap-12">
          {error ? (
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-5">
                <div className="bg-surface-container-lowest rounded-xl shadow-editorial p-1 overflow-hidden">
                  <div className="aspect-[3/4] bg-surface-container-low rounded-lg flex items-center justify-center relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-1 signature-gradient shadow-[0_0_15px_rgba(0,52,97,0.5)] animate-pulse" />
              ...
              <div className="md:col-span-7 flex flex-col gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="h-3 w-full bg-surface-container-highest rounded-full overflow-hidden">
                    <div
                      className="h-full signature-gradient transition-all duration-700"
                    ...
                    <div
                      ...
                      className={`flex items-center gap-4 p-4 rounded-xl shadow-sm border-l-4 transition-all ${
                        i < stage
                          ...
                          : "bg-surface-container-lowest border-outline/20 opacity-50"
                      }`}
                    >
                      <span
                        className={`material-symbols-outlined ${
                          i < stage ? "text-green-600" : "text-primary"
                        }`}
                      >
          ...
          {!error && (
            <div className="fixed bottom-12 left-1/2 -translate-x-1/2 glass-panel py-3 px-6 rounded-full shadow-editorial flex items-center gap-6 border border-white/40">
              <div className="flex items-center gap-2 px-3 py-1 bg-primary text-on-primary rounded-full text-xs font-bold">
